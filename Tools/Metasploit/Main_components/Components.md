...
![Encoders](Tools/Metasploit/Images/Encoders.png)
**Evasion**

While encoders will encode the payload, they should not be considered a direct attempt to evade antivirus software. On the other hand, “evasion” modules will try that, with more or less success.
![Evasion](Tools/Metasploit/Images/Evasion.png)
**Exploits**

Exploits, neatly organized by target system.
![Exploits](Tools/Metasploit/Images/Exploits.png)
**NOPs**

NOPs (No OPeration) do nothing, literally. They are represented in the Intel x86 CPU family with 0x90, following which the CPU will do nothing for one cycle. They are often used as a buffer to achieve consistent payload sizes.
![NOPs](Tools/Metasploit/Images/NOPs.png)
**Payloads**
...
![Payloads](Tools/Metasploit/Images/Payloads.png)
